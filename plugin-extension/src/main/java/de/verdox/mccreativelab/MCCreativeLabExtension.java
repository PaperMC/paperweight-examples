...
public class MCCreativeLabExtension extends JavaPlugin implements Listener {
    ...
    private static final CustomBlockRegistry CUSTOM_BLOCK_REGISTRY = new CustomBlockRegistry();
    ...
    private boolean createResourcePack() {
        getCustomBlockRegistry().values().forEachRemaining(fakeBlock -> {
    ...
    private boolean buildPackAndZipFiles() {
        try {
            ...
            if (!getCustomBlockRegistry().isEmpty()) {
                try {
