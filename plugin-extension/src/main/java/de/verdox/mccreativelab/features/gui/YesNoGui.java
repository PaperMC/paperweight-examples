...
public class YesNoGui extends CustomGUIBuilder {
    ...
    public static final Translatable YES = new Translatable(LanguageInfo.ENGLISH_US, "yes", "Yes");
    public static final Translatable NO = new Translatable(LanguageInfo.ENGLISH_US, "no", "No");
    ...
    public YesNoGui() {
        ...
        withMultiLineText("question", 10, 30, 8, StringAlign.Alignment.CENTER, new ScreenPosition(50, 50, 0, 80, 1), 1f,
            RenderedElementBehavior.createWhileOpen((activeGUI, player, renderedGroupMultiLineText) -> {
    ...
    public static class Builder {
        ...
        private ClickableItem.Builder yesButton = new ClickableItem.Builder(Material.LIME_DYE).withItemMeta(itemMeta -> itemMeta.displayName(Component.translatable(YES.key())));
        private ClickableItem.Builder noButton = new ClickableItem.Builder(Material.RED_DYE).withItemMeta(itemMeta -> itemMeta.displayName(Component.translatable(NO.key())));
